 ...
 */
public class FB_AsyncFacebookRunner {

	FB_Facebook fb;

	public FB_AsyncFacebookRunner(FB_Facebook fb) {
		this.fb = fb;
	}
			...
			public void run() {
				try {
					...
					if (response.length() == 0 || response.equals("false")) {
						listener.onFacebookError(new FB_FacebookError("auth.expireSession failed"), state);
						return;
					}
	 ...
	 *            itself.
	 */
	// public void request(Bundle parameters, RequestListener listener,final
	// Object state) {
	 ...
	 *            itself.
	 */
	// // public void request(String graphPath,RequestListener listener,final
	// Object state) {
	...
	public static interface RequestListener {
		 ...
		 * Executed by a background thread: do not update the UI in this method.
		 */
		public void onFacebookError(FB_FacebookError e, Object state);
